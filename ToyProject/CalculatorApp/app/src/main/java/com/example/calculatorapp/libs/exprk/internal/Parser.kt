...
import com.example.calculatorapp.libs.exprk.ExpressionException
import com.example.calculatorapp.libs.exprk.internal.TokenType.*
...
internal class Parser(private val tokens: List<Token>) {
    ...
    private fun comparison(): Expr {
        ...
        while (match(GREATER, GREATER_EQUAL, LESS,
                LESS_EQUAL
            )) {
            val operator = previous()
            val right = addition()
